    ...
    <div className="flex flex-col md:flex-row items-center justify-between bg-surface-container-lowest rounded-xl p-6 border border-outline-variant/15">
      <div className="flex items-center gap-4 mb-4 md:mb-0">
        ...
        <div>
          ...
          <p className="text-xs text-on-surface-variant">Our support team is online to help with your application.</p>
        </div>
      </div>
      <button className="px-6 py-3 rounded-full bg-surface-container-high text-primary font-bold text-sm hover:bg-surface-container-highest transition-colors">
        Contact Support
      </button>
    </div>
  );
