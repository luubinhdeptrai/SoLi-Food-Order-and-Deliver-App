    ...
    <div className="xl:col-span-7 space-y-8">
      <div>
        ...
        <p className="text-slate-600">
          Fill in the form bellow to describe your restaurant. The information
      ...
      <div className="space-y-6">
        ...
        <section className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-700 font-headline">
              Restaurant Name
            </label>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select required className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white transition-all outline-none appearance-none">
