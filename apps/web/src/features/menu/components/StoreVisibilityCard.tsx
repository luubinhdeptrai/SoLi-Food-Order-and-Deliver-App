    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <ShoppingBag
            className="h-5 w-5"
            style={{ color: isOpen ? "#ffffff" : "var(--on-surface-variant)" }}
          />
        </div>
        <div>
          <p
          ...
          <div className="flex items-center gap-1.5 mt-0.5">
            ...
            <span
              ...
              style={{
                color: isOpen ? "rgba(255,255,255,0.8)" : "var(--on-surface-variant)",
              }}
            >
      ...
      <div className="flex items-center gap-2">
        <Label
          ...
          style={{ color: isOpen ? "rgba(255,255,255,0.7)" : "var(--on-surface-variant)" }}
        >
          {isOpen ? "Open" : "Closed"}
        </Label>
        <Switch
