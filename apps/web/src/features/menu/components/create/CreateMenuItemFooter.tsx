...
export function CreateMenuItemFooter({ onDiscard, onPublish }: CreateMenuItemFooterProps) {
  return (
    <div className="mt-12 flex items-center justify-between bg-card p-6 rounded-3xl shadow-sm border border-border/50">
      <div className="flex items-center gap-4">
        ...
        <p className="text-sm text-muted-foreground">Draft last saved today at 10:42 AM</p>
      </div>
